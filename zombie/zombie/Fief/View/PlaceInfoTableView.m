...
@implementation PlaceInfoTableView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (_isDefaultPlace) {
        ...
        displayProperty.displayObject = [PlaceScene sharedScene].place;
    }
    else {
        
        displayProperty.displayObject = _place;
    }
