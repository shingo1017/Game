...
- (void)actionResult {
    ...
    [survivorPickerScene showWithPickNumberOfSurvivors:5 titleKeys:titleKeys placeConsumables:@{k_material : @10} survivorConsumables:@{k_stamina : @40} completion:^(NSArray<Survivor *> *selectedSurvivors) {
...
- (void)actionResult {
    ...
    SurvivorsPickerScene *survivorPickerScene = [SurvivorsPickerScene new];
    [survivorPickerScene showWithPickNumberOfSurvivors:3 titleKeys:titleKeys placeConsumables:nil survivorConsumables:@{k_stamina : @30} completion:^(NSArray<Survivor *> *selectedSurvivors) {
