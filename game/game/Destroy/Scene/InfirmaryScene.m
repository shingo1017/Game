...
#import "InfirmaryScene.h"

@implementation InfirmaryScene
...
- (id)init {
    ...
    if (self) {
        ...
        [self setProperty:@"医务室" forKey:@"sceneImageName" save:NO];
        ...
        [myAction setValue:@[myInfoAction, myRestAction, mySleepAction] forKey:@"actions"];
        ...
        id talkAction = [Utility objectForClassName:@"TalkAction"];
        id infirmaryCheckExitAction = [Utility objectForClassName:@"InfirmaryCheckExitAction"];
        id loungeAction = [Utility objectForClassName:@"LoungeAction"];
        [self setProperty:@[myAction, bagAction, mobilePhoneAction, talkAction, infirmaryCheckExitAction, loungeAction] forKey:@"actions" save:NO];
    }
    return self;
}
