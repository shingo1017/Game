...
- (void)awakeFromNib {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(reloadData) name:K_SHOULD_RELOAD_BAG_NOTIFICATION object:nil];
...
- (void)show {
    ...
    Group *group = [Utility objectForClassName:@"BagInfoGroup"];
...
- (void)reloadData {
    ...
    _items = [[Bag sharedBag] itemGroups];
...
- (void)reloadActions {
    ...
    id closeAction = [Utility objectForClassName:@"BagViewCloseAction"];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    id itemEquipBagAction = [Utility objectForClassName:@"ItemEquipBagAction"];
    id storeAction = [Utility objectForClassName:@"BagViewStoreAction"];
    id dropAction = [Utility objectForClassName:@"BagViewDropAction"];
    id closeAction = [Utility objectForClassName:@"BagViewCloseAction"];
    _actions = [_actions arrayByAddingObjectsFromArray:@[itemEquipBagAction, storeAction, dropAction, closeAction]];
    [Action appendActions:_actions];
